...
def main_DP(name, data1, data1_std):
    ...
    P_m = []
    B_m = []
    for root, dirs, files in os.walk(rP.bulk_aB() + '/' + str(name)):
        if len(files) > 1:
    ...
    if optimize_parameters.capitalize() == "Y":
        ...
        class MichealistMenten:
            ...
            def train(self, config: Configuration, seed: int = 0) -> float:
                ...
                predicted_data = pd.read_csv(rP.ab_experimental('AlamarblueRawdataWTKGy.csv'), names=COLUMN_NAMES)
                predicted_data_std = pd.read_csv(rP.ab_experimental('AlamarblueRawdataWTKGySTD.csv'), names=COLUMN_NAMES)
        ...
        # Now rad51
        datar = pd.read_csv(rP.ab_experimental("AlamarblueRawdatarad51KGy.csv"), names = namesk)
        datarSTD = pd.read_csv(rP.ab_experimental("AlamarblueRawdatarad51KGySTD.csv"), names = namesk)

        datar2 = pd.read_csv(rP.ab_experimental("AlamarblueRawdatarad5125Gy.csv"), names = namesk)
        datarSTD2 = pd.read_csv(rP.ab_experimental("AlamarblueRawdatarad5125GySTD.csv"), names = namesk)

        datar3 = pd.read_csv(rP.ab_experimental("AlamarblueRawdatarad515Gy.csv"), names = namesk)
        datarSTD3 = pd.read_csv(rP.ab_experimental("AlamarblueRawdatarad515GySTD.csv"), names = namesk)

        datar5 = pd.read_csv(rP.ab_experimental("AlamarblueRawdatarad5110Gy.csv"), names = namesk)
        datarSTD5 = pd.read_csv(rP.ab_experimental("AlamarblueRawdatarad5110GySTD.csv"), names = namesk)

        datar6 = pd.read_csv(rP.ab_experimental("AlamarblueRawdatarad5120Gy.csv"), names = namesk)
        datarSTD6 = pd.read_csv(rP.ab_experimental("AlamarblueRawdatarad5120GySTD.csv"), names = namesk)

        datar7 = pd.read_csv(rP.ab_experimental("AlamarblueRawdatarad5130Gy.csv"), names = namesk)
        datarSTD7 = pd.read_csv(rP.ab_experimental("AlamarblueRawdatarad5130GySTD.csv"), names = namesk)
        ...
        # Now WT
        dataw = pd.read_csv(rP.ab_experimental("AlamarblueRawdataWTKGy.csv"), names = namesk)
        datawSTD = pd.read_csv(rP.ab_experimental("AlamarblueRawdataWTKGySTD.csv"), names = namesk)

        dataw2 = pd.read_csv(rP.ab_experimental("AlamarblueRawdataWT25Gy.csv"), names = namesk)
        datawSTD2 = pd.read_csv(rP.ab_experimental("AlamarblueRawdataWT25GySTD.csv"), names = namesk)

        dataw3 = pd.read_csv(rP.ab_experimental("AlamarblueRawdataWT10Gy.csv"), names = namesk)
        datawSTD3 = pd.read_csv(rP.ab_experimental("AlamarblueRawdataWT10GySTD.csv"), names = namesk)

        dataw4 = pd.read_csv(rP.ab_experimental("AlamarblueRawdataWT5Gy.csv"), names = namesk)
        datawSTD4 = pd.read_csv(rP.ab_experimental("AlamarblueRawdataWT5GySTD.csv"), names = namesk)

        dataw5 = pd.read_csv(rP.ab_experimental("AlamarblueRawdataWT20Gy.csv"), names = namesk)
        datawSTD5 = pd.read_csv(rP.ab_experimental("AlamarblueRawdataWT20GySTD.csv"), names = namesk)

        dataw6 = pd.read_csv(rP.ab_experimental("AlamarblueRawdataWT30Gy.csv"), names = namesk)
        datawSTD6 = pd.read_csv(rP.ab_experimental("AlamarblueRawdataWT30GySTD.csv"), names = namesk)
