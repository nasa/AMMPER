...
if __name__ == "__main__":
    ...
    if optimize_parameters.capitalize() == "Y":
        ...
        namesk = ['Time', 'A570', 'A600', 'A690', 'A750']
            ##############
        data1 = pd.read_csv(rP.ab_experimental('AlamarblueRawdataWTKGy.csv'),
                            names = namesk) # Average 0 Gy, use Average data instead of single data >>>>>>> <<<<<<<<<<<< Re run 4 rank tensor gridsearch

        data2 = pd.read_csv(rP.ab_experimental('AlamarblueRawdataWT25Gy.csv'),
                            names = namesk) # Average 0 Gy, use Average data instead of single data >>>>>>> <<<<<<<<<<<< Re run 4 rank tensor gridsearch

        data3 = pd.read_csv(rP.ab_experimental('AlamarblueRawdataWT30Gy.csv'),
                            names = namesk) # Average 0 Gy, use Average data instead of single data >>>>>>> <<<<<<<<<<<< Re run 4 rank tensor gridsearch

        data1STD = pd.read_csv(rP.ab_experimental('AlamarblueRawdataWTKGySTD.csv'),
                            names = namesk) # Average 0 Gy, use Average data instead of single data >>>>>>> <<<<<<<<<<<< Re run 4 rank tensor gridsearch
        # "

        data2STD = pd.read_csv(rP.ab_experimental('AlamarblueRawdataWT25GySTD.csv'),
                            names = namesk) # Average 0 Gy, use Average data instead of single data >>>>>>> <<<<<<<<<<<< Re run 4 rank tensor gridsearch

        data3STD = pd.read_csv(rP.ab_experimental('AlamarblueRawdataWT30GySTD.csv'),
                            names = namesk) # Average 0 Gy, use Average data instead of single data >>>>>>> <<<<<<<<<<<< Re run 4 rank tensor gridsearch
